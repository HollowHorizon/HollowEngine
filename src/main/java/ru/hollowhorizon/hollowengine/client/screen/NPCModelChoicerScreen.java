    ...
    public void drawCard(PoseStack stack, int modelType, double mouseX) {
        ...
        switch (modelType) {
            case 0:
                ...
                GUIHelper.drawSizedStringWithWidth(stack, fr, Component.literal("Добавляет модели со скелетными анимациями. Поддерживаемые форматы: .smd"),
            ...
            case 1:
                ...
                GUIHelper.drawSizedStringWithWidth(stack, fr, Component.literal("Добавляет модели из BlockBench, в том числе и анимированные. Поддерживаемые форматы: .json"),
            ...
            case 2:
                ...
                GUIHelper.drawSizedStringWithWidth(stack, fr, Component.literal("Добавляет модели, которые уже есть у других мобов в игре, пока только ванильных."),
