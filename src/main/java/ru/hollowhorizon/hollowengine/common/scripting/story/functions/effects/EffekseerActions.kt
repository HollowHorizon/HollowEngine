...
fun Level.playSound(location: String, volume: Float = 1f, pitch: Float = 1f, position: Vec3? = null, velocity: Vec3? = null, relative: Boolean = false) {
...
fun Player.playSound(location: String, volume: Float = 1f, pitch: Float = 1f, position: Vec3? = null, velocity: Vec3? = null, relative: Boolean = false) {
