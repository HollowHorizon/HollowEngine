package ru.hollowhorizon.hollowengine.common.project.kt.signaturehelp
...
import ru.hollowhorizon.hollowengine.common.project.kt.completion.DECL_RENDERER
import ru.hollowhorizon.hollowengine.common.project.kt.completion.identifierOverloads
import ru.hollowhorizon.hollowengine.common.project.kt.completion.memberOverloads
import ru.hollowhorizon.hollowengine.common.project.kt.docs.findDoc
import ru.hollowhorizon.hollowengine.common.project.kt.util.findParent
import ru.hollowhorizon.hollowengine.common.project.kt.util.nullResult
...
private fun activeSignature(call: KtCallExpression, candidates: List<CallableDescriptor>): Int? {
    ...
    if (activeIndex < 0) {
        HollowEngine.LOGGER.warn("No activeSignature found, omitting from SignatureHelp response.")
        return null
    }
    return activeIndex
}
