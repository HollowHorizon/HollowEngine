package ru.hollowhorizon.hollowengine.common.project.kt.position
...
fun location(declaration: DeclarationDescriptor): Location? {
    ...
    if (declaration is DeclarationDescriptorWithSource) {
        ...
        when (sourceFile) {
            ...
            else -> HollowEngine.LOGGER.info("Source type of {} not recognized", sourceFile)
        }
    } else {
        HollowEngine.LOGGER.info("{} does not have a source", declaration)
    }
