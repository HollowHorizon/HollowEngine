...
import ru.hollowhorizon.hollowstory.client.screen.widget.dialogue.DialogueTextBox
...
class DialogueScreen(location: File, val onCloseCallback: () -> Unit = {}) : HollowScreen(StringTextComponent("")) {
