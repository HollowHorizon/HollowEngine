package ru.hollowhorizon.hollowstory.client.screen.widget.dialogue;

import net.minecraft.client.gui.chat.NarratorChatListener;
import net.minecraft.util.text.*;
import ru.hollowhorizon.hc.client.screens.widget.HollowWidget;
import ru.hollowhorizon.hollowstory.client.screen.widget.FadeInLabelWidget;
...
public class DialogueTextBox extends HollowWidget {
    ...
    public void complete() {
        this.labelTop.complete();
        this.labelMiddle.complete();
        this.labelBottom.complete();
    }
        ...
        for (int i = 0; i < lines.size(); i++) {
            switch (i) {
                case 0:
                    ...
                    labelMiddle.complete();
                    labelBottom.complete();
                    break;
                case 1:
