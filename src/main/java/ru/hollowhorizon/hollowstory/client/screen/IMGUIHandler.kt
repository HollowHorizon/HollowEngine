...
import ru.hollowhorizon.hollowstory.client.screen.imgui.lockLists
import ru.hollowhorizon.hollowstory.client.screen.imgui.orEquals
...
object IMGUIHandler {
    ...
    private fun setupStyle(style: ImGuiStyle) {
        ...
        font = loadFont(ResourceLocation("hollowstory:fonts/roboto.ttf"), 16f)
    }
