...
public class JBColor extends Color {
    ...
    @NotNull
    Color getColor() {
        return func != null ? func.produce() : getDarkVariant();
    }
    ...
    public static final JBColor red = new JBColor(Color.red, Color.RED);
    public static final JBColor RED = red;

    public static final JBColor blue = new JBColor(Color.blue, Color.BLUE);
    ...
    public static final JBColor gray = new JBColor(Color.gray, Color.gray);
    public static final JBColor GRAY = gray;

    public static final JBColor lightGray = new JBColor(Color.lightGray, Color.lightGray);
    public static final JBColor LIGHT_GRAY = lightGray;

    public static final JBColor darkGray = new JBColor(Color.darkGray, Color.darkGray);
