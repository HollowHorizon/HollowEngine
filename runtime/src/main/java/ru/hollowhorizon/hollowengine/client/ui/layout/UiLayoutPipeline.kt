...
import ru.hollowhorizon.hollowengine.client.ui.widgets.textFieldInlayStyle
import ru.hollowhorizon.hollowengine.client.ui.widgets.textFieldTextOffset
import ru.hollowhorizon.hollowengine.client.ui.widgets.textFieldWrap
import ru.hollowhorizon.hollowengine.client.ui.widgets.toHighlightedRichText
import java.util.*
...
class UiLayoutPipeline {
    ...
    internal fun placeRowChildren(
        ...
        var x = content.x + mainAlign.mainStartOffset(content.width, totalWidth, grown.size)
    ...
    internal fun placeColumnChildren(
        ...
        var y = content.y + mainAlign.mainStartOffset(content.height, totalHeight, grown.size)
        ...
        layouts[node]?.let { layoutNode ->
            layouts[node] = layoutNode.copy(
                virtualContentBounds = UiRect(
                    content.x,
                    unscrolledTop + mainAlign.mainStartOffset(content.height, totalHeight, measured.size),
                    measured.maxOfOuterWidth(),
                    totalHeight,
                )
            )
        }
        var y = content.y + mainAlign.mainStartOffset(content.height, totalHeight, measured.size)
    ...
    internal fun placeLazyRowChildren(
        ...
        layouts[node]?.let { layoutNode ->
            layouts[node] = layoutNode.copy(
                virtualContentBounds = UiRect(
                    unscrolledLeft + mainAlign.mainStartOffset(content.width, totalWidth, measured.size),
                    content.y,
                    totalWidth,
        ...
        var x = content.x + mainAlign.mainStartOffset(content.width, totalWidth, measured.size)
