...
fun Vec4f.toMutableVec4d(result: MutableVec4d = MutableVec4d()) =
...
fun Vec4d.toMutableVec4f(result: MutableVec4f = MutableVec4f()) =
...
fun Vec4i.toMutableVec4f(result: MutableVec4f = MutableVec4f()) =
    result.set(x.toFloat(), y.toFloat(), z.toFloat(), w.toFloat())

fun Vec4i.toVec4d() = Vec4d(x.toDouble(), y.toDouble(), z.toDouble(), w.toDouble())
fun Vec4i.toMutableVec4d(result: MutableVec4d = MutableVec4d()) =
    result.set(x.toDouble(), y.toDouble(), z.toDouble(), w.toDouble())
...
open class Vec4f(open val x: Float, open val y: Float, open val z: Float, open val w: Float) {
    ...
    fun isFuzzyEqual(that: Vec4f, eps: Float = FUZZY_EQ_F): Boolean =
        isFuzzyEqual(x, that.x, eps) && isFuzzyEqual(y, that.y, eps) && isFuzzyEqual(z, that.z, eps) && isFuzzyEqual(
            w,
            that.w,
            eps
        )
...
open class MutableVec4f(override var x: Float, override var y: Float, override var z: Float, override var w: Float) :
    Vec4f(x, y, z, w) {
     ...
     */
    operator fun plusAssign(that: Vec4f) {
        add(that)
    }
     ...
     */
    operator fun plusAssign(that: Float) {
        add(that)
    }
     ...
     */
    operator fun minusAssign(that: Vec4f) {
        subtract(that)
    }
     ...
     */
    operator fun minusAssign(that: Float) {
        subtract(that)
    }
     ...
     */
    operator fun timesAssign(that: Vec4f) {
        mul(that)
    }
     ...
     */
    operator fun timesAssign(that: Float) {
        mul(that)
    }
...
open class MutableVec4d(
     ...
     */
    operator fun plusAssign(that: Vec4d) {
        add(that)
    }
     ...
     */
    operator fun minusAssign(that: Vec4d) {
        subtract(that)
    }
     ...
     */
    operator fun timesAssign(that: Vec4d) {
        mul(that)
    }
...
open class MutableVec4i(override var x: Int, override var y: Int, override var z: Int, override var w: Int) :
    Vec4i(x, y, z, w) {
     ...
     */
    operator fun plusAssign(that: Vec4i) {
        add(that)
    }
     ...
     */
    operator fun minusAssign(that: Vec4i) {
        subtract(that)
    }
     ...
     */
    operator fun timesAssign(that: Vec4i) {
        mul(that)
    }
