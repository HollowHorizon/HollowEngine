...
object UiLanguageCatalog {
    ...
    val valueCompletions = mapOf(
        ...
        "shape" to listOf("path(\"M 0 0 L 100 0 L 100 100 L 0 100 Z\", 100 100)"),
        ...
        "clip" to listOf("true", "false", "path(\"M 0 0 L 100 0 L 100 100 L 0 100 Z\", 100 100)"),
