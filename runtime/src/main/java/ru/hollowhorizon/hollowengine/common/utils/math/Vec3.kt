...
open class Vec3f(open val x: Float, open val y: Float, open val z: Float) {
    ...
    /**
     * Rotates this vector by the given [Angle] around the given axis and returns the result in a
...
open class MutableVec3f(override var x: Float, override var y: Float, override var z: Float) : Vec3f(x, y, z) {
    ...
    /**
     * Inplace operation: Rotates this vector by the given [Angle] around the given axis.
     */
