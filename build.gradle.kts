...
dependencies {
    install("com.github.HollowHorizon.HollowCore:HollowCore-${container.modPlatform}-${container.minecraftVersion}:$hollowcore:dev", includeInJar = false, isMod = container.modPlatform == "forge")
    include("com.github.HollowHorizon.HollowCore:HollowCore-${container.modPlatform}-${container.minecraftVersion}:$hollowcore")
